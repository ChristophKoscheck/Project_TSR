...
history = model_regulation.fit(train_images, train_labels, validation_data=(test_images, test_labels), epochs=15, callbacks=[monitored])
...
# Save the model
model_regulation.save("Test_Model.h5")